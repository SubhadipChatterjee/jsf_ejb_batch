...
public class TimerView extends HttpServlet {

    private static final Logger LOG = LoggerFactory.getLogger(TimerView.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h3>Servlet CheckTimer at " + request.getContextPath() + "</h3>");

            out.println("<br/>");
            out.println("Last Automatic Timer timestamp -> " + timerSessionBean.getLastAutomaticTimeout());
            out.println("<br/>");
